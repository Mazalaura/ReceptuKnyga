...
export class AuthService {
    ...
    signup(email:string, password:string){
        return this.http.post<AuthResponse>("https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyDfRQkltl2iI1YGSOuQrNT-4VCQydOdyMw",
        {
            email:email,
            password:password,
    ...
    login(email:string, password:string){
        return this.http.post<AuthResponse>('https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyDfRQkltl2iI1YGSOuQrNT-4VCQydOdyMw',
        {
            email:email,
            password:password,
            returnSecureToken:true
